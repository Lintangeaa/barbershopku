                        ...
                        >
                            <div className="relative group hover:cursor-pointer">
                                <div className="relative overflow-hidden rounded-lg">
                                    ...
                                    />
                                    <div className="absolute bottom-0 left-0 right-0 bg-brown bg-opacity-50 text-white p-4 transform translate-y-20 group-hover:translate-y-0 transition-all duration-500">
